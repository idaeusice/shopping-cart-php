...
INSERT INTO `daintree_db`.`customer` (`email`, `first_name`, `last_name`, `password`, `admin`, `privacy`) VALUES ('admin@daintree.com', 'Admin', 'Account', '$2y$10$xq4x3d4H.wUKn33h0VKwe.OaiX0a4bbB/TSe5KSLSqiDW4qZs3iOa', '1', '1');
